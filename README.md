# Privacy Policy
VatanSoft built the EnRandevu app as a Commercial app. This SERVICE is provided by VatanSoft and is intended for use as is.
...
We upload your contact list to our server(https://api.enrandevu.com ) upon your permission in order to find the users already signed up for our system. We do not store your contact list information and immediately delete it after the requested process is done.
...
Our users who may want their data to be deleted should contact us via email (destek@enrandevu.net)
...
Contact Us
If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at destek@enrandevu.net
